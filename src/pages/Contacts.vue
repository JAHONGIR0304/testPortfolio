<template>
    <div class="contacts">
        <h1 class="boo"></h1>
        <span class="me__content-text">Можете позвонить по телефону: <a class="me__content-text a" href="tel:+998935585925"> <img src="../assets/images/phone.png" alt=""></a></span>
        <span class="me__content-text">Telegram: <a class="me__content-text a" href="https://t.me/showtimejoha"><img src="../assets/images/tg.png" alt=""></a></span>
    </div>
    <div class="birds">
